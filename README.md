...
## Current status (2026-09-26T00:15:41+00:00 UTC)

459 models polled, 1401 inference endpoints:
up 860, degraded 97, down 10, idle 434.
...
| `qwen/qwen3.6-35b-a3b` | `deepinfra/fp8` | DeepInfra | 73% | 100% |
| `z-ai/glm-5` | `amazon-bedrock` | Amazon Bedrock | 57% | 49% |
