...
## Current status (2026-09-21T20:31:26+00:00 UTC)

443 models polled, 1336 inference endpoints:
up 826, degraded 94, down 28, idle 388.
...
| `deepseek/deepseek-v4-flash` | `baidu/fp8` | Baidu | 75% | 86% |
...
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 77% | 22% |
| `google/gemma-4-31b-it` | `chutes/fp4` | Chutes | 76% | 33% |
| `google/gemma-4-31b-it` | `novita/bf16` | Novita | 79% | 91% |
| `meta-llama/llama-3.3-70b-instruct` | `together` | Together | 78% | 71% |
| `minimax/minimax-m2.5` | `venice` | Venice | n/a | n/a |
| `minimax/minimax-m2.7` | `mara` | Mara | 71% | 71% |
| `nvidia/nemotron-3-ultra-550b-a55b` | `venice/fp8` | Venice | 75% | 100% |
| plus 13 more | | | | |
