...
## Current status (2026-09-08T01:31:21+00:00 UTC)

428 models polled, 1295 inference endpoints:
up 774, degraded 84, down 26, idle 411.
...
| `google/gemini-3-flash-preview` | `google-vertex/global/flex` | Google | 9% | 8% |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 62% | 59% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 74% | 100% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 71% | 100% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 71% | 76% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 74% | 100% |
| `moonshotai/kimi-k3` | `parasail/fp4` | Parasail | 69% | 50% |
| `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` | `nvidia` | Nvidia | 78% | 73% |
| `openai/gpt-5.6-luna` | `azure/eu` | Azure | 68% | 100% |
