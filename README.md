...
## Current status (2026-08-27T08:00:38+00:00 UTC)

417 models polled, 1264 inference endpoints:
up 779, degraded 115, down 18, idle 352.

Currently down (18):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `amazon/nova-micro-v1` | `amazon-bedrock/eu-west-1` | Amazon Bedrock | 55% | 57% |
| `deepseek/deepseek-chat-v3-0324` | `deepinfra/fp4` | DeepInfra | 79% | 100% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | 73% | 80% |
| `deepseek/deepseek-v4-flash-0731` | `makora` | Makora | 80% | 85% |
| `deepseek/deepseek-v4-pro-0813` | `deepinfra/fp8` | DeepInfra | 74% | 99% |
| `deepseek/deepseek-v4-pro-0813` | `together` | Together | 76% | n/a |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 36% | 24% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 63% | 61% |
| `mistralai/mistral-large` | `mistral` | Mistral | 68% | n/a |
| `mistralai/mistral-nemo` | `deepinfra/fp8` | DeepInfra | 65% | 63% |
| `moonshotai/kimi-k2-thinking` | `novita/bf16` | Novita | 72% | n/a |
| `openai/gpt-5.4-nano` | `openai` | OpenAI | 77% | 74% |
| `openai/gpt-oss-120b` | `google-vertex/global` | Google | 72% | 68% |
| `openai/gpt-oss-20b` | `google-vertex/us-central1` | Google | 79% | 100% |
| `qwen/qwen3.5-122b-a10b` | `siliconflow/fp8` | SiliconFlow | 80% | 100% |
| plus 3 more | | | | |
