...
## Current status (2026-09-04T06:31:20+00:00 UTC)

427 models polled, 1289 inference endpoints:
up 795, degraded 88, down 33, idle 373.
...
| `anthropic/claude-fable-5.1` | `google-vertex/global` | Google | 54% | n/a |
| `deepseek/deepseek-chat-v3.1` | `mara` | Mara | 78% | 81% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | n/a | n/a |
| `deepseek/deepseek-v4-flash` | `azure/us` | Azure | 79% | 80% |
| `deepseek/deepseek-v4-flash-0731` | `morph/bf16` | Morph | 77% | 32% |
| `deepseek/deepseek-v4-flash-0731` | `gmicloud/fp8` | GMICloud | 57% | 63% |
| `deepseek/deepseek-v4-pro` | `digitalocean` | DigitalOcean | 0% | n/a |
| `deepseek/deepseek-v4-pro` | `fireworks` | Fireworks | 0% | n/a |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 62% | 77% |
| `google/gemini-2.5-pro` | `google-vertex/eu` | Google | 6% | 6% |
| `google/gemini-2.5-pro` | `google-ai-studio` | Google AI Studio | 70% | 66% |
| `google/gemini-2.5-pro-preview` | `google-vertex/eu` | Google | 6% | 6% |
| `google/gemini-2.5-pro-preview` | `google-ai-studio` | Google AI Studio | 70% | 66% |
| `google/gemini-2.5-pro-preview-05-06` | `google-vertex/eu` | Google | 6% | 6% |
| plus 18 more | | | | |
