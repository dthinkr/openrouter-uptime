...
## Current status (2026-08-17T03:15:37+00:00 UTC)

414 models polled, 1214 inference endpoints:
up 737, degraded 113, down 19, idle 345.
...
| `google/gemini-2.5-pro` | `google-vertex/eu` | Google | 20% | n/a |
| `google/gemini-2.5-pro-preview-05-06` | `google-vertex/eu` | Google | 20% | n/a |
| `google/gemini-3.1-pro-preview` | `google-vertex/global` | Google | 68% | 73% |
| `google/gemini-3.1-pro-preview` | `google-vertex/global/flex` | Google | 68% | 73% |
| `google/gemini-3.1-pro-preview` | `google-vertex/global/priority` | Google | 68% | 73% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 62% | 68% |
| `meta-llama/llama-3.3-70b-instruct` | `cloudflare/fp8` | Cloudflare | 72% | n/a |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 38% | 42% |
| `moonshotai/kimi-k2-thinking` | `novita/bf16` | Novita | 80% | 82% |
| `nvidia/nemotron-nano-12b-v2-vl:free` | `nvidia` | Nvidia | 75% | 77% |
| `openai/gpt-5.4-nano` | `openai` | OpenAI | 60% | 55% |
| `openai/gpt-5.4-nano` | `openai/flex` | OpenAI | 60% | 55% |
| `openai/gpt-oss-20b` | `phala` | Phala | 80% | 76% |
| `qwen/qwen3-vl-235b-a22b-instruct` | `deepinfra/fp8` | DeepInfra | 65% | n/a |
| plus 4 more | | | | |
