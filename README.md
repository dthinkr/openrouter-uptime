...
## Current status (2026-09-14T06:43:56+00:00 UTC)

445 models polled, 1341 inference endpoints:
up 793, degraded 101, down 21, idle 426.
...
| `deepseek/deepseek-chat-v3-0324` | `deepinfra/fp4` | DeepInfra | 26% | 40% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | 0% | n/a |
| `deepseek/deepseek-v4-flash-vision-exp` | `atlas-cloud/fp8` | AtlasCloud | 78% | n/a |
| `google/gemini-3-flash-preview` | `google-vertex/global/flex` | Google | 61% | n/a |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 52% | 70% |
| `moonshotai/kimi-k3` | `inference-net` | InferenceNet | 75% | 87% |
| `openai/gpt-5.6-luna` | `azure` | Azure | 68% | 73% |
| `openai/gpt-5.6-luna` | `azure/us` | Azure | 68% | 84% |
| `openai/gpt-5.6-luna-pro` | `azure` | Azure | 78% | n/a |
| `openai/gpt-6-astra` | `azure/us` | Azure | 78% | 100% |
| `openai/gpt-oss-120b` | `together` | Together | 56% | 21% |
| `openai/gpt-oss-20b` | `google-vertex/us-central1` | Google | 70% | n/a |
| `qwen/qwen3.5-122b-a10b` | `siliconflow/fp8` | SiliconFlow | 0% | n/a |
| `xiaomi/mimo-v2.5` | `gmicloud/fp8` | GMICloud | 59% | 39% |
| plus 6 more | | | | |
