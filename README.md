...
## Current status (2026-08-23T05:00:28+00:00 UTC)

422 models polled, 1225 inference endpoints:
up 758, degraded 80, down 24, idle 363.

Currently down (24):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `amazon/nova-micro-v1` | `amazon-bedrock` | Amazon Bedrock | 62% | 59% |
| `amazon/nova-micro-v1` | `amazon-bedrock/eu-west-1` | Amazon Bedrock | 8% | 6% |
| `deepseek/deepseek-chat` | `deepinfra/fp4` | DeepInfra | 60% | 97% |
| `deepseek/deepseek-chat-v3.1` | `siliconflow/fp8` | SiliconFlow | 54% | 71% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | 62% | n/a |
| `deepseek/deepseek-v3.1-terminus` | `siliconflow/fp8` | SiliconFlow | 48% | n/a |
...
| `minimax/minimax-m2.7` | `deepinfra/turbo` | DeepInfra | 70% | 0% |
...
| `openai/gpt-5.4-nano` | `openai` | OpenAI | 70% | 59% |
| plus 9 more | | | | |
