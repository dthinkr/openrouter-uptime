...
## Current status (2026-09-24T14:15:35+00:00 UTC)

458 models polled, 1385 inference endpoints:
up 871, degraded 127, down 18, idle 369.
...
| `deepseek/deepseek-v4-flash-vision-exp` | `deepinfra/fp8` | DeepInfra | 69% | 60% |
...
| `moonshotai/kimi-k2.6` | `crusoe/bf16` | Crusoe | 72% | 43% |
| `moonshotai/kimi-k2.6` | `fireworks` | Fireworks | 0% | 0% |
| `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` | `nvidia` | Nvidia | 71% | 72% |
| `openai/gpt-6-luna` | `azure` | Azure | 56% | 100% |
| `openai/gpt-oss-20b` | `google-vertex/us-central1` | Google | 50% | 100% |
| `qwen/qwen3-235b-a22b-2507` | `deepinfra/fp8` | DeepInfra | 79% | 60% |
| `qwen/qwen3-235b-a22b-2507` | `venice/fp8` | Venice | 80% | 65% |
| `qwen/qwen3-next-80b-a3b-instruct` | `novita/bf16` | Novita | 64% | 64% |
| plus 3 more | | | | |
