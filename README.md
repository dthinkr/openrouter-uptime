...
## Current status (2026-09-05T01:31:23+00:00 UTC)

431 models polled, 1296 inference endpoints:
up 767, degraded 70, down 19, idle 440.
...
| `deepseek/deepseek-v4-flash` | `azure/us` | Azure | 58% | 97% |
| `deepseek/deepseek-v4-flash-0731` | `morph/bf16` | Morph | 69% | 30% |
| `deepseek/deepseek-v4-flash-0731` | `gmicloud/fp8` | GMICloud | 62% | 54% |
| `deepseek/deepseek-v4-pro` | `fireworks` | Fireworks | 0% | n/a |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 47% | 30% |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 5% | 4% |
| `google/gemini-3.8-flash` | `google-vertex/global/flex` | Google | 48% | n/a |
| `google/gemma-4-31b-it` | `deepinfra/fp8` | DeepInfra | 78% | 76% |
...
| `xiaomi/mimo-v2.5` | `gmicloud/fp8` | GMICloud | 22% | 58% |
| `z-ai/glm-4.7` | `mancer/fp4` | Mancer 2 | 74% | 72% |
| plus 4 more | | | | |
