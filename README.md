...
## Current status (2026-08-20T12:31:08+00:00 UTC)

414 models polled, 1213 inference endpoints:
up 743, degraded 150, down 21, idle 299.
...
| `deepseek/deepseek-chat-v3-0324` | `deepinfra/fp4` | DeepInfra | 64% | 53% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | 69% | n/a |
| `deepseek/deepseek-v3.2` | `deepinfra/fp4` | DeepInfra | 76% | n/a |
| `deepseek/deepseek-v3.2` | `venice` | Venice | 19% | n/a |
...
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 66% | 1% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 73% | 99% |
| `google/gemma-4-31b-it` | `chutes/fp4` | Chutes | 66% | 61% |
