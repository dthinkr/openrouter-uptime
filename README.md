...
## Current status (2026-09-01T23:15:12+00:00 UTC)

419 models polled, 1273 inference endpoints:
up 791, degraded 88, down 23, idle 371.
...
| `deepseek/deepseek-r1-0528` | `siliconflow/fp8` | SiliconFlow | 68% | 100% |
| `deepseek/deepseek-v4-pro` | `fireworks` | Fireworks | 0% | 0% |
| `google/gemini-2.5-pro` | `google-ai-studio` | Google AI Studio | 79% | 71% |
| `google/gemini-2.5-pro-preview` | `google-ai-studio` | Google AI Studio | 79% | 71% |
| `google/gemini-2.5-pro-preview-05-06` | `google-ai-studio` | Google AI Studio | 79% | 71% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 69% | 35% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 69% | 100% |
| `google/gemma-4-31b-it` | `novita/bf16` | Novita | 73% | 99% |
| `google/gemma-4-31b-it` | `phala` | Phala | 6% | 1% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 37% | n/a |
| `meta/muse-glimmer-30b` | `parasail/bf16` | Parasail | n/a | n/a |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 62% | 59% |
| `moonshotai/kimi-k2.6` | `baseten/fp4#5dab5ba2f2#1` | BaseTen | 41% | 74% |
| `moonshotai/kimi-k3` | `morph/fp4` | Morph | 0% | n/a |
| plus 8 more | | | | |
