...
## Current status (2026-09-14T01:01:21+00:00 UTC)

445 models polled, 1339 inference endpoints:
up 800, degraded 83, down 17, idle 439.
...
| `deepseek/deepseek-v4-pro-0813` | `baseten/fp4#75902459f9#1` | BaseTen | 78% | n/a |
| `google/gemini-3-flash-preview` | `google-vertex/global/flex` | Google | 2% | n/a |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 76% | 63% |
| `google/gemma-4-31b-it` | `together` | Together | 78% | n/a |
| `moonshotai/kimi-k2.5` | `novita` | Novita | 74% | 33% |
| `moonshotai/kimi-k3` | `inference-net` | InferenceNet | 54% | 100% |
| `openai/gpt-5.6-luna` | `azure` | Azure | 77% | 75% |
| `openai/gpt-5.6-luna` | `azure/us` | Azure | 63% | 95% |
...
| `z-ai/glm-4.6` | `z-ai/fp4` | Z.AI | 41% | n/a |
