...
## Current status (2026-09-17T07:45:50+00:00 UTC)

444 models polled, 1338 inference endpoints:
up 784, degraded 130, down 25, idle 399.
...
| `deepseek/deepseek-v4-pro-0813` | `baseten/fp4#e04fe012db#2` | BaseTen | 67% | n/a |
| `deepseek/deepseek-v4-pro-0813` | `venice` | Venice | 74% | n/a |
...
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 61% | 52% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 79% | 56% |
| `google/gemma-4-26b-a4b-it` | `venice/bf16` | Venice | 78% | 95% |
| `google/gemma-4-31b-it` | `deepinfra/ultra` | DeepInfra | 18% | 100% |
| `minimax/minimax-m3` | `venice/fp8` | Venice | 62% | 74% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 36% | 100% |
| `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` | `nvidia` | Nvidia | 75% | 75% |
| `nvidia/nemotron-3.5-lightning` | `phala` | Phala | 2% | n/a |
| plus 10 more | | | | |
