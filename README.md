...
## Current status (2026-08-31T11:31:27+00:00 UTC)

396 models polled, 1239 inference endpoints:
up 782, degraded 125, down 17, idle 315.
...
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 75% | 78% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 76% | 73% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 70% | n/a |
| `minimax/minimax-m3` | `gmicloud/fp8` | GMICloud | 80% | 82% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 61% | 56% |
| `openai/gpt-5.6-sol` | `openai/fast` | OpenAI | 76% | n/a |
| `openai/gpt-oss-20b` | `fireworks` | Fireworks | 0% | 0% |
| `qwen/qwen3-235b-a22b-2507` | `gmicloud/fp8` | GMICloud | 48% | n/a |
| `qwen/qwen3.5-397b-a17b` | `deepinfra/fp8` | DeepInfra | 80% | n/a |
| `xiaomi/mimo-v2.5` | `gmicloud/fp8` | GMICloud | 43% | 74% |
