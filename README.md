...
## Current status (2026-09-08T09:30:52+00:00 UTC)

428 models polled, 1296 inference endpoints:
up 742, degraded 147, down 30, idle 377.
...
| `deepseek/deepseek-v4-flash-0731` | `mancer/fp8` | Mancer 2 | 75% | 74% |
| `deepseek/deepseek-v4-flash-0731` | `gmicloud/fp8` | GMICloud | 71% | 84% |
...
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 73% | 35% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 76% | 100% |
| `google/gemma-4-31b-it` | `together` | Together | 72% | 63% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 54% | 57% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 32% | 48% |
| plus 15 more | | | | |
