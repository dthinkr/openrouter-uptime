...
## Current status (2026-09-23T10:46:10+00:00 UTC)

454 models polled, 1382 inference endpoints:
up 863, degraded 122, down 21, idle 376.
...
| `deepseek/deepseek-v4-flash` | `streamlake/fp8` | StreamLake | n/a | 0% |
| `deepseek/deepseek-v4-flash` | `azure/us` | Azure | 74% | 100% |
| `deepseek/deepseek-v4-flash-0731` | `nebius/fp8` | Nebius | 78% | 69% |
...
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 55% | 16% |
| `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` | `nvidia` | Nvidia | 61% | 73% |
| `nvidia/nemotron-3-ultra-550b-a55b` | `venice/fp8` | Venice | 63% | 62% |
| `openai/gpt-oss-120b` | `novita/fp4` | Novita | 35% | n/a |
| `openai/gpt-oss-120b` | `siliconflow/fp8` | SiliconFlow | 67% | 0% |
| `openai/gpt-oss-120b` | `phala` | Phala | 77% | n/a |
| `openai/gpt-oss-120b` | `deepinfra/fp8` | DeepInfra | 61% | 99% |
| plus 6 more | | | | |
