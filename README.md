...
## Current status (2026-09-22T21:46:03+00:00 UTC)

453 models polled, 1365 inference endpoints:
up 848, degraded 81, down 23, idle 413.
...
| `deepseek/deepseek-v4-flash` | `azure/us` | Azure | 52% | 97% |
...
| `google/gemma-4-31b-it` | `siliconflow/fp8` | SiliconFlow | 47% | 98% |
| `meta-llama/llama-3.3-70b-instruct` | `together` | Together | 75% | n/a |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 57% | 19% |
| `nex-agi/nex-n2.5-mini:free` | `nex-agi/bf16` | Nex AGI | 37% | 56% |
| `openai/gpt-oss-120b` | `novita/fp4` | Novita | 70% | n/a |
| `openai/gpt-oss-120b` | `phala` | Phala | 75% | n/a |
| `qwen/qwen3.5-35b-a3b` | `atlas-cloud/fp8` | AtlasCloud | 76% | n/a |
| `qwen/qwen3.6-35b-a3b` | `phala` | Phala | 77% | 48% |
| `qwen/qwen3.6-35b-a3b` | `siliconflow/fp8` | SiliconFlow | 54% | 100% |
| plus 8 more | | | | |
