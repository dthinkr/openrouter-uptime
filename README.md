...
## Current status (2026-09-22T18:31:33+00:00 UTC)

452 models polled, 1360 inference endpoints:
up 835, degraded 107, down 31, idle 387.
...
| `amazon/nova-micro-v1` | `amazon-bedrock/eu-west-1` | Amazon Bedrock | 75% | 22% |
| `deepseek/deepseek-chat-v3-0324` | `deepinfra/fp4` | DeepInfra | 54% | 100% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | 0% | n/a |
| `deepseek/deepseek-v4-flash-0731` | `nebius/fp8` | Nebius | 56% | 100% |
| `deepseek/deepseek-v4-flash-vision-exp` | `deepinfra/fp8` | DeepInfra | 62% | 57% |
| `deepseek/deepseek-v4-pro` | `cloudflare` | Cloudflare | 73% | n/a |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 53% | n/a |
| `google/gemini-3.1-pro-preview` | `google-vertex/global/flex` | Google | 6% | n/a |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 73% | 74% |
| `google/gemma-4-31b-it` | `friendli` | Friendli | 79% | 100% |
| `google/gemma-4-31b-it` | `novita/bf16` | Novita | 67% | 70% |
| `google/gemma-4-31b-it` | `deepinfra/ultra` | DeepInfra | 0% | 0% |
| `google/gemma-4-31b-it` | `siliconflow/fp8` | SiliconFlow | 5% | 99% |
