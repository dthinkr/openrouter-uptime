...
## Current status (2026-09-08T01:15:40+00:00 UTC)

428 models polled, 1295 inference endpoints:
up 781, degraded 77, down 25, idle 412.
...
| `amazon/nova-micro-v1` | `amazon-bedrock/eu-west-1` | Amazon Bedrock | 42% | 18% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | n/a | n/a |
| `deepseek/deepseek-v4-flash` | `azure/us` | Azure | 70% | 100% |
| `deepseek/deepseek-v4-flash-0731` | `gmicloud/fp8` | GMICloud | 79% | 78% |
| `deepseek/deepseek-v4-pro` | `fireworks` | Fireworks | 0% | n/a |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 61% | 61% |
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 37% | 100% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 76% | 100% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 71% | 47% |
| `moonshotai/kimi-k3` | `parasail/fp4` | Parasail | 77% | n/a |
| `openai/gpt-5.6-luna` | `azure/eu` | Azure | 58% | 51% |
| `openai/gpt-oss-120b` | `phala` | Phala | 78% | n/a |
| `openai/gpt-oss-120b` | `together` | Together | 78% | 0% |
