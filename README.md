...
## Current status (2026-09-25T21:15:39+00:00 UTC)

458 models polled, 1408 inference endpoints:
up 869, degraded 95, down 17, idle 427.
...
| `moonshotai/kimi-k2.6` | `digitalocean` | DigitalOcean | 59% | n/a |
| `moonshotai/kimi-k2.6` | `fireworks` | Fireworks | n/a | n/a |
| `openai/gpt-oss-120b` | `google-vertex/global` | Google | 48% | 46% |
| `openai/gpt-oss-120b` | `siliconflow/fp8` | SiliconFlow | 49% | n/a |
| `qwen/qwen3-next-80b-a3b-instruct` | `novita/bf16` | Novita | 52% | 66% |
| `x-ai/grok-4.6` | `xai/zdr/priority` | xAI | 50% | n/a |
| `xiaomi/mimo-v2.5` | `gmicloud/fp8` | GMICloud | 74% | 88% |
| `xiaomi/mimo-v2.5` | `streamlake` | StreamLake | 80% | 92% |
| `xiaomi/mimo-v2.5` | `venice/fp8` | Venice | 62% | n/a |
| `z-ai/glm-4.5-air` | `siliconflow/fp8` | SiliconFlow | 55% | n/a |
| plus 2 more | | | | |
