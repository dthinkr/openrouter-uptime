...
## Current status (2026-09-25T09:46:28+00:00 UTC)

460 models polled, 1404 inference endpoints:
up 891, degraded 90, down 19, idle 404.
...
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 51% | 54% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 71% | 79% |
| `google/gemma-4-31b-it` | `chutes/fp4` | Chutes | 36% | n/a |
| `google/gemma-4-31b-it` | `novita/bf16` | Novita | 65% | 57% |
| `minimax/minimax-m2.5` | `digitalocean` | DigitalOcean | n/a | n/a |
| `minimax/minimax-m2.7` | `deepinfra/turbo` | DeepInfra | 57% | 21% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 61% | 100% |
| `moonshotai/kimi-k2.6` | `crusoe/bf16` | Crusoe | 30% | n/a |
| `moonshotai/kimi-k2.6` | `baseten/fp4#5dab5ba2f2#1` | BaseTen | 77% | 69% |
| `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` | `nvidia` | Nvidia | 74% | 76% |
| `nvidia/nemotron-3-super-120b-a12b` | `dekallm/fp8` | DekaLLM | 73% | 89% |
| `openai/gpt-oss-120b` | `google-vertex/global` | Google | 62% | 62% |
| `qwen/qwen3-next-80b-a3b-instruct` | `novita/bf16` | Novita | 63% | 58% |
