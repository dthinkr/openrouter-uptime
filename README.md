...
## Current status (2026-09-25T01:46:38+00:00 UTC)

460 models polled, 1402 inference endpoints:
up 865, degraded 64, down 19, idle 454.
...
| `deepseek/deepseek-v4-flash-vision-exp` | `deepinfra/fp8` | DeepInfra | 56% | 42% |
...
| `nex-agi/nex-n2.5-pro:free` | `nex-agi/fp8` | Nex AGI | 63% | 32% |
...
| `qwen/qwen3-next-80b-a3b-instruct` | `novita/bf16` | Novita | 72% | 72% |
| `qwen/qwen3.5-397b-a17b` | `streamlake` | StreamLake | 68% | n/a |
| `qwen/qwen3.5-397b-a17b` | `gmicloud/fp8` | GMICloud | 52% | n/a |
| `xiaomi/mimo-v2.5` | `gmicloud/fp8` | GMICloud | 74% | 75% |
| `xiaomi/mimo-v2.5` | `streamlake` | StreamLake | 77% | 72% |
| plus 4 more | | | | |
