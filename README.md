...
## Current status (2026-09-26T01:16:43+00:00 UTC)

459 models polled, 1402 inference endpoints:
up 850, degraded 85, down 17, idle 450.

Currently down (17):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `amazon/nova-lite-v1` | `amazon-bedrock/eu-west-1` | Amazon Bedrock | 76% | 59% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | n/a | n/a |
| `deepseek/deepseek-v3.2` | `venice` | Venice | 64% | 61% |
| `deepseek/deepseek-v4.1-flash` | `dekallm` | DekaLLM | 79% | 100% |
...
| `nvidia/nemotron-3-super-120b-a12b:free` | `nvidia` | Nvidia | 77% | 76% |
...
| `qwen/qwen3-next-80b-a3b-instruct` | `novita/bf16` | Novita | 70% | 74% |
| `qwen/qwen3.5-35b-a3b` | `alibaba` | Alibaba | 12% | n/a |
| plus 2 more | | | | |
