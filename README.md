...
## Current status (2026-09-24T07:31:01+00:00 UTC)

458 models polled, 1387 inference endpoints:
up 860, degraded 100, down 23, idle 404.
...
| `deepseek/deepseek-v4-flash` | `azure/us` | Azure | 75% | 94% |
| `deepseek/deepseek-v4-flash-0731` | `nebius/fp8` | Nebius | 73% | 72% |
...
| `moonshotai/kimi-k3` | `relace/fp4` | Relace | 70% | n/a |
| `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` | `nvidia` | Nvidia | 78% | 80% |
| `openai/gpt-6-luna` | `azure` | Azure | 72% | 73% |
| `openai/gpt-6-luna` | `azure/us` | Azure | 77% | 56% |
| `openai/gpt-6-luna` | `azure/eu` | Azure | 69% | 100% |
| `openai/gpt-oss-120b` | `google-vertex/global` | Google | 75% | 76% |
| `openai/gpt-oss-120b` | `siliconflow/fp8` | SiliconFlow | 0% | 0% |
| `qwen/qwen3-235b-a22b-2507` | `venice/fp8` | Venice | 34% | n/a |
| plus 8 more | | | | |
