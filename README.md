...
## Current status (2026-09-19T08:30:25+00:00 UTC)

447 models polled, 1338 inference endpoints:
up 847, degraded 79, down 16, idle 396.
...
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 75% | 88% |
...
| `moonshotai/kimi-k2.5` | `atlas-cloud/int4` | AtlasCloud | 64% | n/a |
| `moonshotai/kimi-k2.5` | `novita` | Novita | 68% | n/a |
| `moonshotai/kimi-k2.6` | `venice/int4` | Venice | 70% | 64% |
| `qwen/qwen3-vl-30b-a3b-instruct` | `siliconflow/fp8` | SiliconFlow | 71% | n/a |
| `z-ai/glm-4.6` | `z-ai/fp4` | Z.AI | 35% | n/a |
| plus 1 more | | | | |
