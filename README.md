...
## Current status (2026-09-23T04:46:06+00:00 UTC)

454 models polled, 1381 inference endpoints:
up 833, degraded 100, down 17, idle 431.
...
| `deepseek/deepseek-v4-flash-vision-exp` | `deepinfra/fp8` | DeepInfra | 60% | 58% |
| `deepseek/deepseek-v4.1-flash` | `krea/fp8` | Krea | 65% | n/a |
| `minimax/minimax-m3` | `atlas-cloud/fp8` | AtlasCloud | 68% | n/a |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 39% | 100% |
| `nex-agi/nex-n2.5-mini:free` | `nex-agi/bf16` | Nex AGI | 75% | 65% |
| `openai/gpt-oss-120b` | `novita/fp4` | Novita | 59% | 40% |
| `openai/gpt-oss-120b` | `nebius/fp4` | Nebius | 56% | n/a |
| `openai/gpt-oss-120b` | `siliconflow/fp8` | SiliconFlow | 42% | 0% |
| `qwen/qwen3-vl-30b-a3b-instruct` | `siliconflow/fp8` | SiliconFlow | 5% | n/a |
| `qwen/qwen3.6-35b-a3b` | `deepinfra/fp8` | DeepInfra | 49% | 34% |
| `xiaomi/mimo-v2.6-flash` | `deepinfra/fp8` | DeepInfra | 73% | 100% |
| `z-ai/glm-4.7` | `atlas-cloud/fp8` | AtlasCloud | 56% | n/a |
| `z-ai/glm-5.3` | `phala` | Phala | n/a | n/a |
| plus 2 more | | | | |
