...
## Current status (2026-09-15T21:01:35+00:00 UTC)

446 models polled, 1337 inference endpoints:
up 797, degraded 108, down 29, idle 403.
...
| `deepseek/deepseek-chat-v3-0324` | `deepinfra/fp4` | DeepInfra | 80% | 87% |
...
| `google/gemma-4-31b-it` | `siliconflow/fp8` | SiliconFlow | 34% | 76% |
| `minimax/minimax-m3` | `mara` | Mara | 54% | n/a |
| `minimax/minimax-m3` | `sambanova` | SambaNova | 68% | n/a |
