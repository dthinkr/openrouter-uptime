...
## Current status (2026-09-14T11:00:23+00:00 UTC)

445 models polled, 1342 inference endpoints:
up 785, degraded 132, down 22, idle 403.
...
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 16% | 22% |
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 77% | 39% |
| `google/gemma-4-31b-it` | `deepinfra/ultra` | DeepInfra | 60% | n/a |
| `inclusionai/ling-3.0-flash` | `deepinfra/bf16` | DeepInfra | 75% | 50% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 68% | 100% |
| `openai/gpt-5.6-luna` | `azure` | Azure | 56% | 58% |
| `openai/gpt-5.6-luna` | `azure/us` | Azure | 39% | 31% |
| `openai/gpt-oss-120b` | `mara` | Mara | 17% | 54% |
| `openai/gpt-oss-120b` | `deepinfra/fp8` | DeepInfra | 62% | 60% |
| `qwen/qwen3-235b-a22b-2507` | `nebius/fp8` | Nebius | 46% | n/a |
| `qwen/qwen3-vl-30b-a3b-instruct` | `deepinfra/fp8` | DeepInfra | 21% | n/a |
| `qwen/qwen3.5-122b-a10b` | `siliconflow/fp8` | SiliconFlow | 0% | n/a |
| plus 7 more | | | | |
