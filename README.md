...
## Current status (2026-09-20T09:16:31+00:00 UTC)

446 models polled, 1339 inference endpoints:
up 795, degraded 94, down 14, idle 436.
...
| `deepseek/deepseek-v4-flash-vision-exp` | `gmicloud/fp8` | GMICloud | 28% | n/a |
| `deepseek/deepseek-v4-flash-vision-exp` | `siliconflow/fp8` | SiliconFlow | 63% | 100% |
| `deepseek/deepseek-v4-flash-vision-exp` | `novita` | Novita | 5% | n/a |
| `google/gemini-2.5-flash-lite` | `google-vertex` | Google | 40% | 0% |
