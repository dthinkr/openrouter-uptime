...
## Current status (2026-08-29T16:16:29+00:00 UTC)

396 models polled, 1242 inference endpoints:
up 790, degraded 118, down 21, idle 313.
...
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | 73% | 64% |
| `deepseek/deepseek-v4-pro` | `fireworks` | Fireworks | 0% | n/a |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 26% | 23% |
...
| `mistralai/mistral-nemo` | `deepinfra/fp8` | DeepInfra | 66% | 78% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 72% | 76% |
| `moonshotai/kimi-k2.7-code` | `parasail/int4` | Parasail | n/a | n/a |
| `openai/gpt-5` | `openai/default` | OpenAI | 54% | 52% |
| `openai/gpt-oss-20b` | `fireworks` | Fireworks | 0% | 0% |
| `qwen/qwen3-32b` | `siliconflow/fp8` | SiliconFlow | 60% | 60% |
| plus 6 more | | | | |
