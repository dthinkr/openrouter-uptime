...
## Current status (2026-09-21T22:01:33+00:00 UTC)

443 models polled, 1336 inference endpoints:
up 816, degraded 81, down 18, idle 421.
...
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 78% | 91% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 57% | 100% |
| `google/gemma-4-31b-it` | `novita/bf16` | Novita | 52% | 79% |
| `google/gemma-4-31b-it` | `deepinfra/ultra` | DeepInfra | 4% | n/a |
| `google/gemma-4-31b-it` | `siliconflow/fp8` | SiliconFlow | 57% | 100% |
| `meta-llama/llama-3.3-70b-instruct` | `together` | Together | 54% | n/a |
| `minimax/minimax-m2.7` | `mara` | Mara | 75% | 80% |
...
| `openai/gpt-oss-120b` | `deepinfra/fp8` | DeepInfra | 4% | 16% |
| `qwen/qwen3-32b` | `siliconflow/fp8` | SiliconFlow | 69% | n/a |
| plus 3 more | | | | |
