...
## Current status (2026-08-13T11:45:17+00:00 UTC)

409 models polled, 1178 inference endpoints:
up 714, degraded 153, down 18, idle 293.

Currently down (18):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | 65% | 52% |
| `deepseek/deepseek-r1` | `azure` | Azure | n/a | n/a |
| `deepseek/deepseek-v4-flash` | `ambient/fp4` | Ambient | n/a | n/a |
| `deepseek/deepseek-v4-pro` | `cloudflare` | Cloudflare | 73% | 96% |
...
| `nvidia/nemotron-3-ultra-550b-a55b` | `venice/fp8` | Venice | 78% | 62% |
| `nvidia/nemotron-nano-12b-v2-vl:free` | `nvidia` | Nvidia | 73% | 82% |
| `openai/gpt-oss-20b` | `google-vertex/us-central1` | Google | 75% | 83% |
| `qwen/qwen-2.5-72b-instruct` | `novita/bf16` | Novita | 48% | n/a |
| `qwen/qwen3-coder` | `venice/fp8` | Venice | 60% | 100% |
| `z-ai/glm-5` | `amazon-bedrock` | Amazon Bedrock | 70% | n/a |
| `z-ai/glm-5` | `venice/fp8` | Venice | 68% | n/a |
| plus 3 more | | | | |
