...
## Current status (2026-09-10T15:15:00+00:00 UTC)

436 models polled, 1302 inference endpoints:
up 799, degraded 110, down 33, idle 360.
...
| `google/gemma-4-31b-it` | `novita/bf16` | Novita | 52% | n/a |
...
| `minimax/minimax-m2.7` | `mara` | Mara | 18% | n/a |
| plus 18 more | | | | |
