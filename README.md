...
## Current status (2026-09-26T02:31:33+00:00 UTC)

458 models polled, 1400 inference endpoints:
up 828, degraded 95, down 19, idle 458.
...
| `google/gemini-2.5-flash` | `google-vertex` | Google | 62% | 76% |
| `google/gemma-4-31b-it` | `reka` | Reka | 78% | n/a |
| `moonshotai/kimi-k2.6` | `deepinfra/fp4` | DeepInfra | 23% | 15% |
...
| `qwen/qwen3-32b` | `siliconflow/fp8` | SiliconFlow | 74% | 100% |
| `qwen/qwen3-next-80b-a3b-instruct` | `novita/bf16` | Novita | 45% | 58% |
| `qwen/qwen3.5-35b-a3b` | `alibaba` | Alibaba | 19% | n/a |
| `xiaomi/mimo-v2.5` | `gmicloud/fp8` | GMICloud | 57% | n/a |
| `xiaomi/mimo-v2.5` | `streamlake` | StreamLake | 67% | 71% |
| plus 4 more | | | | |
