...
## Current status (2026-09-14T19:01:11+00:00 UTC)

447 models polled, 1345 inference endpoints:
up 792, degraded 126, down 35, idle 392.
...
| `deepseek/deepseek-v4-flash-vision-exp` | `gmicloud/fp8` | GMICloud | 11% | n/a |
| `deepseek/deepseek-v4-flash-vision-exp` | `siliconflow/fp8` | SiliconFlow | 18% | n/a |
| `deepseek/deepseek-v4-flash-vision-exp` | `novita` | Novita | 24% | n/a |
| `deepseek/deepseek-v4.1-flash` | `deepseek` | DeepSeek | 33% | 0% |
| `deepseek/deepseek-v4.1-flash` | `siliconflow/fp8` | SiliconFlow | 11% | 0% |
| `deepseek/deepseek-v4.1-flash` | `gmicloud/fp8` | GMICloud | 5% | 0% |
| `deepseek/deepseek-v4.1-flash` | `novita/fp8` | Novita | 25% | 0% |
| `deepseek/deepseek-v4.1-flash` | `phala` | Phala | 4% | n/a |
...
| `google/gemma-4-26b-a4b-it` | `google-vertex/global` | Google | 71% | n/a |
| `google/gemma-4-31b-it` | `crusoe` | Crusoe | 33% | 95% |
| plus 20 more | | | | |
