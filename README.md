...
## Current status (2026-07-25T22:53:17+00:00 UTC)

335 models polled, 1043 inference endpoints:
up 678, degraded 96, down 29, idle 240.

Currently down (29):

| model | provider | 30m uptime | 5m uptime |
|---|---|---|---|
| `deepseek/deepseek-chat-v3.1` | Mara | 78% | 90% |
| `deepseek/deepseek-v4-pro` | Fireworks | 53% | 97% |
...
| `google/gemini-3.1-flash-image-preview` | Google | 0% | n/a |
| `google/gemma-3-27b-it` | Nebius | 70% | 40% |
| `mistralai/mistral-nemo` | Novita | 73% | 67% |
| `mistralai/mistral-small-3.2-24b-instruct` | Parasail | n/a | n/a |
| `nvidia/nemotron-3-ultra-550b-a55b` | Venice | 64% | n/a |
