...
## Current status (2026-09-22T08:02:07+00:00 UTC)

444 models polled, 1338 inference endpoints:
up 808, degraded 105, down 25, idle 400.
...
| `deepseek/deepseek-v4-flash-vision-exp` | `deepinfra/fp8` | DeepInfra | 76% | 100% |
| `deepseek/deepseek-v4-pro-0813` | `baseten/fp4#e04fe012db#2` | BaseTen | 77% | n/a |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 76% | 77% |
| `google/gemini-3-flash-preview` | `google-vertex/global/flex` | Google | 11% | 100% |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 28% | 96% |
| `google/gemini-3.6-flash` | `google-vertex/global/flex` | Google | 78% | n/a |
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 76% | 95% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 59% | 46% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 71% | 58% |
| `google/gemma-4-31b-it` | `siliconflow/fp8` | SiliconFlow | 16% | 99% |
| `minimax/minimax-m3` | `venice/fp8` | Venice | 61% | 70% |
| `mistralai/mistral-small-3.2-24b-instruct` | `venice/fp8` | Venice | 67% | 22% |
