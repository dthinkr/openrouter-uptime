...
## Current status (2026-09-09T01:46:02+00:00 UTC)

431 models polled, 1298 inference endpoints:
up 763, degraded 105, down 30, idle 400.

Currently down (30):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `deepseek/deepseek-v4-flash-0731` | `gmicloud/fp8` | GMICloud | 54% | 61% |
| `deepseek/deepseek-v4-pro` | `fireworks` | Fireworks | n/a | n/a |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 66% | 62% |
| `google/gemini-2.5-pro` | `google-vertex/eu` | Google | 26% | 12% |
| `google/gemini-2.5-pro-preview` | `google-vertex/eu` | Google | 26% | 12% |
| `google/gemini-2.5-pro-preview-05-06` | `google-vertex/eu` | Google | 26% | 12% |
...
| `google/gemini-3.1-pro-preview` | `google-vertex/global/flex` | Google | 57% | 45% |
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 54% | n/a |
...
| `meta-llama/llama-3.1-70b-instruct` | `deepinfra/turbo` | DeepInfra | 73% | 12% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 43% | 45% |
| plus 15 more | | | | |
