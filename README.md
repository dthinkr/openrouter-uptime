...
## Current status (2026-09-20T23:15:29+00:00 UTC)

446 models polled, 1340 inference endpoints:
up 808, degraded 70, down 21, idle 441.

Currently down (21):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `deepseek/deepseek-chat-v3-0324` | `deepinfra/fp4` | DeepInfra | 45% | 48% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | 0% | n/a |
| `deepseek/deepseek-v4-flash-0731` | `mancer/fp8` | Mancer 2 | 53% | 6% |
| `google/gemini-2.5-flash` | `google-vertex/eu` | Google | 80% | 98% |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 44% | 16% |
| `google/gemini-2.5-pro` | `google-vertex/eu` | Google | 76% | n/a |
| `google/gemini-2.5-pro` | `google-ai-studio` | Google AI Studio | 74% | 77% |
| `google/gemini-2.5-pro` | `google-vertex/us` | Google | 27% | n/a |
| `google/gemini-2.5-pro-preview` | `google-vertex/eu` | Google | 76% | n/a |
| `google/gemini-2.5-pro-preview` | `google-ai-studio` | Google AI Studio | 74% | 77% |
...
| `google/gemini-3.8-flash` | `google-vertex/global/flex` | Google | 72% | 83% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 80% | 100% |
| `moonshotai/kimi-k2.6` | `decart/fp4` | Decart | 78% | n/a |
| plus 6 more | | | | |
