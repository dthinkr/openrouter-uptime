...
## Current status (2026-09-06T15:31:27+00:00 UTC)

430 models polled, 1293 inference endpoints:
up 768, degraded 102, down 22, idle 401.
...
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 63% | 94% |
| `moonshotai/kimi-k2.5` | `phala` | Phala | 79% | 93% |
| `nousresearch/hermes-4-70b` | `nebius/fp8` | Nebius | 0% | n/a |
| `openai/gpt-5.6-luna` | `azure/us` | Azure | 79% | 94% |
| `openai/gpt-oss-120b` | `deepinfra/bf16` | DeepInfra | 66% | 0% |
