...
## Current status (2026-09-08T05:45:38+00:00 UTC)

428 models polled, 1295 inference endpoints:
up 762, degraded 100, down 36, idle 397.
...
| `google/gemini-2.5-flash` | `google-vertex` | Google | 46% | 61% |
| `google/gemini-2.5-pro` | `google-ai-studio` | Google AI Studio | 80% | 80% |
| `google/gemini-2.5-pro-preview` | `google-ai-studio` | Google AI Studio | 80% | 80% |
| `google/gemini-2.5-pro-preview-05-06` | `google-ai-studio` | Google AI Studio | 80% | 80% |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 18% | n/a |
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 55% | 37% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 58% | n/a |
| `meta/muse-glimmer-30b` | `phala` | Phala | 77% | n/a |
| `minimax/minimax-m3` | `atlas-cloud/fp8` | AtlasCloud | 66% | 13% |
| plus 21 more | | | | |
