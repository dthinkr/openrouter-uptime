...
## Current status (2026-09-21T19:16:00+00:00 UTC)

440 models polled, 1333 inference endpoints:
up 822, degraded 105, down 25, idle 381.
...
| `deepseek/deepseek-v4-flash` | `baidu/fp8` | Baidu | 76% | 99% |
| `deepseek/deepseek-v4-pro` | `cloudflare` | Cloudflare | 70% | n/a |
| `deepseek/deepseek-v4-pro-0813` | `wafer` | Wafer | 70% | n/a |
...
| `nvidia/nemotron-3-ultra-550b-a55b` | `venice/fp8` | Venice | 72% | 50% |
| plus 10 more | | | | |
