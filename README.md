...
## Current status (2026-09-18T07:31:39+00:00 UTC)

445 models polled, 1334 inference endpoints:
up 800, degraded 131, down 22, idle 381.
...
| `deepseek/deepseek-v4-flash-0731` | `inceptron/fp4` | Inceptron | 78% | 65% |
...
| `moonshotai/kimi-k2.7-code` | `venice/int4` | Venice | 73% | 20% |
| `openai/gpt-5.4` | `openai/flex` | OpenAI | 67% | n/a |
| `openai/gpt-5.6-sol` | `openai/flex` | OpenAI | 27% | 33% |
| `qwen/qwen3-vl-30b-a3b-instruct` | `deepinfra/fp8` | DeepInfra | 73% | n/a |
| `qwen/qwen3-vl-30b-a3b-instruct` | `siliconflow/fp8` | SiliconFlow | 72% | 98% |
| `thinkingmachines/inkling` | `deepinfra/fp8` | DeepInfra | 66% | n/a |
| `xiaomi/mimo-v2.5` | `gmicloud/fp8` | GMICloud | 76% | 74% |
| plus 7 more | | | | |
