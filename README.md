...
## Current status (2026-08-20T20:46:19+00:00 UTC)

417 models polled, 1216 inference endpoints:
up 772, degraded 114, down 26, idle 304.

Currently down (26):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `amazon/nova-micro-v1` | `amazon-bedrock/eu-west-1` | Amazon Bedrock | 59% | 31% |
| `deepseek/deepseek-chat-v3.1` | `mara` | Mara | 69% | n/a |
| `deepseek/deepseek-v3.2` | `venice` | Venice | 65% | n/a |
| `deepseek/deepseek-v4-flash-0731` | `open-inference/fp4` | OpenInference | 0% | n/a |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 69% | 77% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 67% | 99% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 27% | 18% |
| `meta-llama/llama-3.3-70b-instruct` | `coreweave/fp16` | CoreWeave | 7% | 24% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 48% | 32% |
| `mistralai/mistral-small-2603` | `mistral/zdr` | Mistral | 0% | n/a |
| `moonshotai/kimi-k2.6` | `crusoe/bf16` | Crusoe | 66% | 8% |
| `moonshotai/kimi-k2.7-code` | `modelrun/fp4` | ModelRun | 27% | n/a |
| `moonshotai/kimi-k2.7-code` | `together` | Together | 36% | n/a |
| `moonshotai/kimi-k3` | `deepinfra/bf16` | DeepInfra | 73% | n/a |
| `nvidia/nemotron-3-ultra-550b-a55b` | `venice/fp8` | Venice | 53% | 53% |
| plus 11 more | | | | |
