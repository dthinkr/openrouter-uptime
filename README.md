...
## Current status (2026-09-26T02:46:27+00:00 UTC)

458 models polled, 1400 inference endpoints:
up 834, degraded 98, down 19, idle 449.

Currently down (19):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `amazon/nova-micro-v1` | `amazon-bedrock/eu-west-1` | Amazon Bedrock | 77% | 72% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | n/a | n/a |
| `deepseek/deepseek-v4-flash-0731` | `fireworks` | Fireworks | 48% | 0% |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 74% | 83% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 76% | 100% |
| `moonshotai/kimi-k2.6` | `deepinfra/fp4` | DeepInfra | 21% | 54% |
...
| `qwen/qwen3-next-80b-a3b-instruct` | `novita/bf16` | Novita | 50% | 53% |
| `qwen/qwen3.6-27b` | `chutes/fp8` | Chutes | 72% | n/a |
| `xiaomi/mimo-v2.5` | `gmicloud/fp8` | GMICloud | 55% | n/a |
| `xiaomi/mimo-v2.5` | `streamlake` | StreamLake | 72% | 74% |
