...
## Current status (2026-09-19T10:01:08+00:00 UTC)

447 models polled, 1338 inference endpoints:
up 870, degraded 83, down 16, idle 369.
...
| `google/gemini-3-flash-preview` | `google-vertex/global/flex` | Google | 4% | 7% |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 19% | n/a |
| `google/gemini-3.8-flash` | `google-vertex/global/flex` | Google | 54% | n/a |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 79% | 85% |
| `minimax/minimax-m2.5` | `venice` | Venice | 67% | n/a |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 69% | 57% |
| `moonshotai/kimi-k2.6` | `venice/int4` | Venice | 56% | n/a |
| `openai/gpt-oss-120b` | `novita/fp4` | Novita | 20% | n/a |
| `qwen/qwen3-vl-30b-a3b-instruct` | `deepinfra/fp8` | DeepInfra | 25% | n/a |
| `qwen/qwen3.5-27b` | `siliconflow/fp8` | SiliconFlow | 78% | 74% |
| `qwen/qwen3.5-27b` | `phala` | Phala | 76% | 84% |
