...
## Current status (2026-09-15T08:15:57+00:00 UTC)

445 models polled, 1337 inference endpoints:
up 766, degraded 152, down 40, idle 379.
...
| `google/gemini-3.5-flash` | `google-vertex/us` | Google | 77% | n/a |
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 34% | 54% |
