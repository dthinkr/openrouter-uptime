...
## Current status (2026-08-20T23:15:44+00:00 UTC)

418 models polled, 1218 inference endpoints:
up 761, degraded 119, down 21, idle 317.

Currently down (21):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `amazon/nova-micro-v1` | `amazon-bedrock` | Amazon Bedrock | 71% | 98% |
| `amazon/nova-micro-v1` | `amazon-bedrock/eu-west-1` | Amazon Bedrock | 40% | 90% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | 66% | n/a |
| `deepseek/deepseek-v4-flash-0731` | `digitalocean` | DigitalOcean | 55% | 68% |
...
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 70% | 50% |
| `moonshotai/kimi-k2.7-code` | `modelrun/fp4` | ModelRun | 35% | n/a |
| `moonshotai/kimi-k2.7-code` | `together` | Together | 14% | n/a |
| `nvidia/nemotron-3-ultra-550b-a55b` | `deepinfra/fp4` | DeepInfra | 76% | 97% |
| `nvidia/nemotron-3-ultra-550b-a55b` | `venice/fp8` | Venice | 63% | n/a |
| `openai/gpt-oss-120b` | `sambanova` | SambaNova | 74% | 88% |
| `openai/gpt-oss-120b` | `phala` | Phala | 63% | 5% |
| plus 6 more | | | | |
