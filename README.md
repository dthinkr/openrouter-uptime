...
## Current status (2026-09-09T19:01:28+00:00 UTC)

430 models polled, 1298 inference endpoints:
up 789, degraded 106, down 26, idle 377.
...
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 42% | 8% |
| `google/gemini-3.1-pro-preview` | `google-vertex/global/flex` | Google | 8% | n/a |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 74% | 82% |
| `google/gemma-4-31b-it` | `chutes/fp4` | Chutes | 64% | 98% |
| `google/gemma-4-31b-it` | `deepinfra/ultra` | DeepInfra | 46% | 6% |
| `google/gemma-4-31b-it` | `together` | Together | 72% | 91% |
| `google/gemma-4-31b-it` | `cerebras/fp16` | Cerebras | 0% | 0% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 30% | 28% |
| `moonshotai/kimi-k2.7-code` | `venice/int4` | Venice | 69% | n/a |
| `openai/gpt-5.6-luna` | `azure` | Azure | 76% | 73% |
| `openai/gpt-5.6-luna` | `azure/us` | Azure | 63% | 94% |
| plus 11 more | | | | |
