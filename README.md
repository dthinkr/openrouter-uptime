...
## Current status (2026-09-03T09:46:25+00:00 UTC)

424 models polled, 1283 inference endpoints:
up 760, degraded 140, down 30, idle 353.
...
| `deepseek/deepseek-v3.2` | `mara` | Mara | 73% | n/a |
| `deepseek/deepseek-v4-flash-0731` | `ambient/fp4` | Ambient | 68% | 100% |
| `deepseek/deepseek-v4-pro` | `fireworks` | Fireworks | n/a | n/a |
| `deepseek/deepseek-v4-pro` | `venice` | Venice | 67% | n/a |
| `google/gemini-2.5-pro` | `google-vertex/eu` | Google | 67% | 39% |
| `google/gemini-2.5-pro-preview` | `google-vertex/eu` | Google | 67% | 39% |
| `google/gemini-2.5-pro-preview-05-06` | `google-vertex/eu` | Google | 67% | 39% |
...
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 78% | 4% |
| `google/gemma-3-4b-it` | `deepinfra/bf16` | DeepInfra | n/a | n/a |
