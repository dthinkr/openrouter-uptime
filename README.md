...
## Current status (2026-09-04T07:15:47+00:00 UTC)

427 models polled, 1289 inference endpoints:
up 787, degraded 102, down 26, idle 374.
...
| `google/gemini-2.5-flash` | `google-vertex` | Google | 75% | 51% |
...
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 80% | 99% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 63% | n/a |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 54% | 28% |
