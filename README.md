...
## Current status (2026-09-04T06:15:52+00:00 UTC)

427 models polled, 1289 inference endpoints:
up 794, degraded 89, down 34, idle 372.
...
| `anthropic/claude-fable-5.1` | `google-vertex/global` | Google | 40% | n/a |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | n/a | n/a |
| `deepseek/deepseek-v4-flash-0731` | `gmicloud/fp8` | GMICloud | 58% | 54% |
...
| `google/gemini-2.5-pro` | `google-vertex/eu` | Google | 5% | 8% |
| `google/gemini-2.5-pro` | `google-ai-studio` | Google AI Studio | 75% | 69% |
| `google/gemini-2.5-pro-preview` | `google-vertex/eu` | Google | 5% | 8% |
| `google/gemini-2.5-pro-preview` | `google-ai-studio` | Google AI Studio | 75% | 69% |
| `google/gemini-2.5-pro-preview-05-06` | `google-vertex/eu` | Google | 5% | 8% |
