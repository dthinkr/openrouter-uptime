...
## Current status (2026-09-02T08:46:38+00:00 UTC)

421 models polled, 1274 inference endpoints:
up 776, degraded 123, down 26, idle 349.

Currently down (26):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `deepseek/deepseek-chat-v3.1` | `siliconflow/fp8` | SiliconFlow | 70% | 100% |
| `deepseek/deepseek-chat-v3.1` | `mara` | Mara | 78% | 96% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | 0% | n/a |
| `deepseek/deepseek-v4-flash` | `azure/us` | Azure | 75% | 81% |
| `deepseek/deepseek-v4-flash-0731` | `venice` | Venice | 78% | 72% |
| `deepseek/deepseek-v4-pro` | `fireworks` | Fireworks | n/a | n/a |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 40% | 56% |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 32% | n/a |
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 70% | 72% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 64% | n/a |
| `google/gemma-4-31b-it` | `phala` | Phala | 24% | 0% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 66% | n/a |
| `mistralai/mistral-large` | `mistral` | Mistral | 77% | n/a |
| `mistralai/mistral-nemo` | `deepinfra/fp8` | DeepInfra | 74% | 82% |
