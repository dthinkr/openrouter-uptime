...
## Current status (2026-08-09T07:30:42+00:00 UTC)

400 models polled, 1158 inference endpoints:
up 674, degraded 108, down 16, idle 360.
...
| `anthropic/claude-fable-5` | `google-vertex/global` | Google | 69% | 76% |
| `deepseek/deepseek-r1` | `azure` | Azure | 0% | n/a |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 68% | 69% |
| `google/gemma-4-31b-it` | `together#a464ccc622` | Together | 76% | 37% |
| `meta-llama/llama-3.1-70b-instruct` | `amazon-bedrock` | Amazon Bedrock | 51% | 44% |
...
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 68% | 80% |
| `moonshotai/kimi-k3` | `together` | Together | 71% | 65% |
| `nvidia/nemotron-nano-12b-v2-vl:free` | `nvidia` | Nvidia | 63% | 73% |
| `openai/gpt-oss-20b` | `google-vertex/us-central1` | Google | 25% | n/a |
| `qwen/qwen3-32b` | `alibaba/fp8` | Alibaba | 0% | 0% |
| `qwen/qwen3-coder-30b-a3b-instruct` | `novita/fp8` | Novita | 76% | 96% |
| `qwen/qwen3.5-35b-a3b` | `nextbit/fp8` | NextBit | n/a | 0% |
| plus 1 more | | | | |
