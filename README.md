...
## Current status (2026-09-26T10:01:16+00:00 UTC)

458 models polled, 1405 inference endpoints:
up 915, degraded 76, down 19, idle 395.

Currently down (19):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `amazon/nova-micro-v1` | `amazon-bedrock/eu-west-1` | Amazon Bedrock | 70% | 37% |
...
| `minimax/minimax-m2.5` | `venice` | Venice | 80% | 63% |
...
| `qwen/qwen3-next-80b-a3b-instruct` | `novita/bf16` | Novita | 61% | 98% |
| plus 4 more | | | | |
