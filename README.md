...
## Current status (2026-09-11T06:30:43+00:00 UTC)

439 models polled, 1317 inference endpoints:
up 772, degraded 129, down 32, idle 384.
...
| `deepseek/deepseek-v4-flash-0731` | `baseten/fp8#9961def773` | BaseTen | 80% | 95% |
...
| `google/gemini-3.7-flash` | `google-ai-studio/priority` | Google AI Studio | 75% | n/a |
| `google/gemma-4-26b-a4b-it` | `makora` | Makora | 0% | n/a |
| `google/gemma-4-31b-it` | `chutes/fp4` | Chutes | 74% | 41% |
| `google/gemma-4-31b-it` | `sambanova` | SambaNova | 58% | 78% |
| `minimax/minimax-m3` | `coreweave/fp4` | CoreWeave | 56% | 68% |
| plus 17 more | | | | |
