...
## Current status (2026-08-22T12:15:36+00:00 UTC)

421 models polled, 1223 inference endpoints:
up 780, degraded 88, down 17, idle 338.
...
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 49% | 36% |
| `mistralai/mistral-small-2603` | `mistral/zdr` | Mistral | 0% | 0% |
| `moonshotai/kimi-k2.7-code` | `modelrun/fp4` | ModelRun | 0% | n/a |
| `moonshotai/kimi-k3` | `morph/fp4` | Morph | 77% | 23% |
| `moonshotai/kimi-k3` | `wafer` | Wafer | 49% | 24% |
| `moonshotai/kimi-k3` | `morph/fast` | Morph | 77% | 17% |
| `openai/gpt-oss-120b` | `google-vertex/global` | Google | 78% | 76% |
| `qwen/qwen-2.5-7b-instruct` | `together` | Together | 0% | n/a |
| `qwen/qwen3-vl-235b-a22b-instruct` | `venice/fp8` | Venice | 26% | n/a |
