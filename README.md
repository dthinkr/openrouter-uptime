...
## Current status (2026-09-12T23:15:26+00:00 UTC)

445 models polled, 1333 inference endpoints:
up 800, degraded 86, down 11, idle 436.
...
| `google/gemma-4-31b-it` | `novita/bf16` | Novita | 80% | 72% |
| `google/gemma-4-31b-it` | `deepinfra/ultra` | DeepInfra | 78% | 13% |
| `minimax/minimax-m3` | `atlas-cloud/fp8` | AtlasCloud | 19% | n/a |
| `qwen/qwen3-next-80b-a3b-instruct` | `deepinfra/fp8` | DeepInfra | 66% | n/a |
...
| `z-ai/glm-5.3` | `makora/fp4` | Makora | 70% | 100% |
