...
## Current status (2026-09-11T08:01:34+00:00 UTC)

439 models polled, 1318 inference endpoints:
up 775, degraded 134, down 28, idle 381.
...
| `deepseek/deepseek-v4-flash` | `streamlake/fp8` | StreamLake | 61% | 100% |
| `deepseek/deepseek-v4-flash` | `alibaba/fp8` | Alibaba | 66% | 100% |
| `deepseek/deepseek-v4-flash` | `azure/us` | Azure | 60% | 98% |
| `deepseek/deepseek-v4-flash-0731` | `baseten/fp8#b635da8df9` | BaseTen | 61% | 72% |
| `deepseek/deepseek-v4-flash-0731` | `baseten/fp8#9961def773` | BaseTen | 63% | 80% |
...
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 71% | 22% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 73% | 53% |
| `google/gemma-4-31b-it` | `sambanova` | SambaNova | 74% | n/a |
| `minimax/minimax-m2.7` | `mara` | Mara | 73% | 70% |
| plus 13 more | | | | |
