...
## Current status (2026-08-26T20:15:47+00:00 UTC)

416 models polled, 1249 inference endpoints:
up 797, degraded 100, down 26, idle 326.
...
| `google/gemini-2.5-flash` | `google-vertex` | Google | 67% | 63% |
...
| `google/gemini-2.5-pro-preview-05-06` | `google-vertex/us` | Google | 11% | n/a |
| `google/gemini-2.5-pro-preview-05-06` | `google-vertex/eu` | Google | 6% | n/a |
| `google/gemma-4-26b-a4b-it` | `cloudflare` | Cloudflare | 71% | 55% |
| `google/gemma-4-31b-it` | `chutes/fp4` | Chutes | 80% | 92% |
| `google/gemma-4-31b-it` | `siliconflow/fp8` | SiliconFlow | 72% | 99% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 59% | 29% |
| `moonshotai/kimi-k2.6` | `gmicloud/fp8` | GMICloud | 70% | n/a |
| `moonshotai/kimi-k2.6` | `fireworks` | Fireworks | n/a | n/a |
| `openai/gpt-5.6-luna` | `azure` | Azure | 77% | 78% |
| plus 11 more | | | | |
