...
## Current status (2026-09-09T13:31:37+00:00 UTC)

431 models polled, 1298 inference endpoints:
up 788, degraded 140, down 23, idle 347.
...
| `google/gemini-3-flash-preview` | `google-vertex/global/flex` | Google | 27% | 30% |
| `google/gemini-3-flash-preview` | `google-vertex/global` | Google | 66% | 63% |
...
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 71% | 73% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 33% | 23% |
| `minimax/minimax-m3` | `atlas-cloud/fp8` | AtlasCloud | 34% | n/a |
| `mistralai/mistral-medium-3` | `mistral` | Mistral | 76% | n/a |
| `mistralai/mistral-medium-3.1` | `mistral/zdr` | Mistral | 54% | 45% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 53% | 64% |
| `moonshotai/kimi-k3` | `makora` | Makora | 60% | n/a |
| `nousresearch/hermes-4-70b` | `nebius/fp8` | Nebius | 0% | 0% |
| `openai/gpt-5.4` | `openai/flex` | OpenAI | 72% | 77% |
| plus 8 more | | | | |
