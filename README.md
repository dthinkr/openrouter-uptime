...
## Current status (2026-09-17T04:00:33+00:00 UTC)

444 models polled, 1338 inference endpoints:
up 791, degraded 91, down 27, idle 429.
...
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 62% | 32% |
...
| `moonshotai/kimi-k2.6` | `baidu/fp4` | Baidu | 80% | 100% |
| `moonshotai/kimi-k2.6` | `fireworks` | Fireworks | n/a | n/a |
| `moonshotai/kimi-k3` | `morph/fp8` | Morph | 63% | n/a |
| `moonshotai/kimi-k3` | `inference-net/fp4` | InferenceNet | 64% | 100% |
| plus 12 more | | | | |
