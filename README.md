...
## Current status (2026-09-21T19:01:06+00:00 UTC)

440 models polled, 1333 inference endpoints:
up 812, degraded 112, down 18, idle 391.
...
| `deepseek/deepseek-chat-v3-0324` | `deepinfra/fp4` | DeepInfra | 66% | 95% |
...
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 71% | 43% |
| `meta-llama/llama-3.3-70b-instruct` | `together` | Together | 78% | n/a |
| `minimax/minimax-m3` | `mara` | Mara | 26% | n/a |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 61% | 100% |
| `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` | `nvidia` | Nvidia | 77% | 76% |
| `openai/gpt-5.6-luna-pro` | `azure` | Azure | 67% | 43% |
| `openai/gpt-5.6-sol` | `openai/flex` | OpenAI | 78% | 84% |
| `openai/gpt-oss-120b` | `mara` | Mara | 78% | 79% |
| `qwen/qwen3.5-35b-a3b` | `siliconflow/fp8` | SiliconFlow | 43% | n/a |
| plus 3 more | | | | |
