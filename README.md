...
## Current status (2026-09-25T16:01:27+00:00 UTC)

458 models polled, 1406 inference endpoints:
up 870, degraded 121, down 23, idle 392.
...
| `minimax/minimax-m3` | `coreweave/fp4` | CoreWeave | 67% | 100% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 56% | 83% |
| `moonshotai/kimi-k2.6` | `coreweave/fp4` | CoreWeave | 74% | 100% |
| `moonshotai/kimi-k2.6` | `venice/int4` | Venice | 69% | n/a |
| `nvidia/nemotron-3-nano-omni-30b-a3b-reasoning:free` | `nvidia` | Nvidia | 78% | 74% |
| `openai/gpt-oss-120b` | `google-vertex/global` | Google | 56% | 69% |
| `openai/gpt-oss-120b` | `mara` | Mara | 59% | n/a |
| `qwen/qwen3-coder` | `deepinfra/turbo` | DeepInfra | 73% | 100% |
| `qwen/qwen3-coder` | `venice/fp8` | Venice | 58% | n/a |
| `qwen/qwen3-coder` | `novita/fp8` | Novita | 79% | 82% |
| `qwen/qwen3-next-80b-a3b-instruct` | `novita/bf16` | Novita | 62% | 70% |
| `qwen/qwen3.5-35b-a3b` | `alibaba` | Alibaba | 47% | n/a |
| plus 8 more | | | | |
