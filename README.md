...
## Current status (2026-09-05T11:01:31+00:00 UTC)

431 models polled, 1298 inference endpoints:
up 781, degraded 101, down 18, idle 398.
...
| `google/gemini-3-flash-preview` | `google-vertex/global/flex` | Google | 7% | 29% |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 28% | n/a |
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 61% | 39% |
...
| `qwen/qwen3-235b-a22b-2507` | `nebius/fp8` | Nebius | 59% | 52% |
| `xiaomi/mimo-v2.5-pro` | `gmicloud/bf16` | GMICloud | 33% | 43% |
| `xiaomi/mimo-v2.5-pro` | `deepinfra/fp8` | DeepInfra | 66% | 15% |
| `xiaomi/mimo-v2.5-pro` | `xiaomi/fp8` | Xiaomi | 73% | 89% |
| plus 3 more | | | | |
