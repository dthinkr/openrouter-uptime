...
## Current status (2026-09-24T22:15:51+00:00 UTC)

460 models polled, 1405 inference endpoints:
up 892, degraded 69, down 17, idle 427.
...
| `qwen/qwen3-30b-a3b-instruct-2507` | `nebius/fp8` | Nebius | 71% | 96% |
...
| `z-ai/glm-4.6` | `novita/bf16` | Novita | 43% | 58% |
| plus 2 more | | | | |
