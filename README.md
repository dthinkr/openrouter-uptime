...
## Current status (2026-09-03T23:46:10+00:00 UTC)

425 models polled, 1284 inference endpoints:
up 792, degraded 105, down 15, idle 372.
...
| `deepseek/deepseek-v4-flash-0731` | `morph/bf16` | Morph | 80% | 98% |
| `deepseek/deepseek-v4-flash-0731` | `gmicloud/fp8` | GMICloud | 68% | 82% |
| `deepseek/deepseek-v4-pro` | `fireworks` | Fireworks | 0% | n/a |
| `google/gemini-3-flash-preview` | `google-vertex/global/flex` | Google | 4% | n/a |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 67% | 85% |
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 36% | 38% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 74% | 99% |
| `google/gemma-4-31b-it` | `siliconflow/fp8` | SiliconFlow | 63% | 12% |
| `google/gemma-4-31b-it` | `novita/bf16` | Novita | 76% | 25% |
...
| `z-ai/glm-5.2` | `mistral` | Mistral | 70% | 56% |
