...
## Current status (2026-09-18T20:46:12+00:00 UTC)

446 models polled, 1335 inference endpoints:
up 793, degraded 106, down 22, idle 414.
...
| `google/gemma-4-31b-it` | `deepinfra/ultra` | DeepInfra | 21% | 35% |
| `minimax/minimax-m2.5` | `venice` | Venice | 8% | 0% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 41% | 100% |
| `moonshotai/kimi-k2.6` | `decart/fp4` | Decart | 59% | 77% |
| `moonshotai/kimi-k2.6` | `venice/int4` | Venice | 58% | n/a |
| `moonshotai/kimi-k2.6` | `fireworks` | Fireworks | n/a | n/a |
| `qwen/qwen3-30b-a3b-instruct-2507` | `nebius/fp8` | Nebius | 65% | 81% |
| `qwen/qwen3.8-27b` | `deepinfra/bf16` | DeepInfra | 73% | 60% |
| plus 7 more | | | | |
