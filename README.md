...
## Current status (2026-09-02T01:16:01+00:00 UTC)

419 models polled, 1272 inference endpoints:
up 737, degraded 120, down 31, idle 384.
...
| `google/gemini-2.5-flash` | `google-vertex/eu` | Google | 17% | 17% |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 67% | 46% |
| `google/gemini-2.5-pro` | `google-ai-studio` | Google AI Studio | 79% | 88% |
| `google/gemini-2.5-pro-preview` | `google-ai-studio` | Google AI Studio | 79% | 78% |
| `google/gemini-2.5-pro-preview-05-06` | `google-ai-studio` | Google AI Studio | 79% | 88% |
...
| `mistralai/mistral-nemo` | `deepinfra/fp8` | DeepInfra | 80% | 89% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 70% | 79% |
| `moonshotai/kimi-k2.6` | `venice/int4` | Venice | 36% | 4% |
| `moonshotai/kimi-k2.6` | `baseten/fp4#5dab5ba2f2#1` | BaseTen | 56% | 42% |
| plus 16 more | | | | |
