...
## Current status (2026-09-22T10:46:17+00:00 UTC)

444 models polled, 1339 inference endpoints:
up 830, degraded 116, down 29, idle 364.
...
| `deepseek/deepseek-v4-flash-0731` | `nebius/fp8` | Nebius | 3% | 1% |
| `deepseek/deepseek-v4-flash-vision-exp` | `deepinfra/fp8` | DeepInfra | 65% | 57% |
| `deepseek/deepseek-v4-pro-0813` | `coreweave/fp8` | CoreWeave | 75% | 100% |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 64% | 64% |
| `google/gemini-2.5-flash-lite` | `google-vertex` | Google | 6% | n/a |
| `google/gemini-2.5-pro` | `google-vertex/global` | Google | 70% | 65% |
| `google/gemini-2.5-pro` | `google-vertex/us` | Google | 59% | n/a |
| `google/gemini-2.5-pro-preview` | `google-vertex/global` | Google | 70% | 65% |
| `google/gemini-2.5-pro-preview` | `google-vertex/us` | Google | 59% | n/a |
...
| `google/gemini-3.6-flash` | `google-vertex/global/flex` | Google | 61% | n/a |
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 70% | 97% |
| plus 14 more | | | | |
