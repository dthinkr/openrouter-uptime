...
## Current status (2026-09-02T10:16:13+00:00 UTC)

421 models polled, 1274 inference endpoints:
up 772, degraded 119, down 24, idle 359.

Currently down (24):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `amazon/nova-micro-v1` | `amazon-bedrock/eu-west-1` | Amazon Bedrock | 32% | 11% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | n/a | n/a |
| `deepseek/deepseek-v4-pro` | `fireworks` | Fireworks | n/a | n/a |
| `google/gemini-3.1-flash-lite` | `google-vertex/global/flex` | Google | 79% | 66% |
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 74% | 53% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 65% | n/a |
| `google/gemma-4-31b-it` | `novita/bf16` | Novita | 51% | 100% |
| `google/gemma-4-31b-it` | `phala` | Phala | 21% | 82% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 39% | n/a |
| `mistralai/mistral-large` | `mistral/zdr` | Mistral | 75% | 84% |
| `mistralai/mistral-large-2512` | `mistral` | Mistral | 78% | 83% |
| `mistralai/mistral-nemo` | `deepinfra/fp8` | DeepInfra | 73% | 39% |
| `moonshotai/kimi-k2.6` | `gmicloud/fp8` | GMICloud | 72% | 75% |
| `moonshotai/kimi-k3` | `parasail/fp4` | Parasail | 59% | n/a |
