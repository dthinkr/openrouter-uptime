...
## Current status (2026-09-23T09:00:54+00:00 UTC)

454 models polled, 1381 inference endpoints:
up 856, degraded 106, down 22, idle 397.
...
| `deepseek/deepseek-v3.2` | `digitalocean` | DigitalOcean | 71% | 100% |
| `deepseek/deepseek-v4-flash` | `streamlake/fp8` | StreamLake | n/a | n/a |
| `deepseek/deepseek-v4-flash` | `azure/us` | Azure | 79% | 69% |
| `deepseek/deepseek-v4-flash-0731` | `nebius/fp8` | Nebius | 11% | n/a |
| `deepseek/deepseek-v4-flash-vision-exp` | `deepinfra/fp8` | DeepInfra | 71% | 70% |
| `deepseek/deepseek-v4-pro-0813` | `venice` | Venice | 78% | n/a |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 65% | 66% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 61% | 73% |
| `minimax/minimax-m2.5` | `venice` | Venice | 26% | n/a |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 61% | 86% |
| `nvidia/nemotron-3-ultra-550b-a55b` | `venice/fp8` | Venice | 64% | 97% |
| `nvidia/nemotron-3.5-lightning` | `phala` | Phala | 73% | n/a |
| `openai/gpt-oss-120b` | `novita/fp4` | Novita | 44% | 40% |
