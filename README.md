...
## Current status (2026-08-14T20:45:59+00:00 UTC)

411 models polled, 1209 inference endpoints:
up 729, degraded 132, down 16, idle 332.
...
| `deepseek/deepseek-chat-v3-0324` | `deepinfra/fp4` | DeepInfra | 77% | 90% |
| `deepseek/deepseek-v4-flash` | `sail-research/fp4` | Sail Research | 75% | 0% |
| `google/gemini-2.5-flash` | `google-vertex` | Google | 63% | 79% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 58% | n/a |
| `google/gemma-4-31b-it` | `together#a464ccc622` | Together | 41% | 19% |
| `google/gemma-4-31b-it` | `together#8ece1e354a` | Together | 57% | 23% |
| `liquid/lfm-2.5-2.6b:free` | `liquid/fp8` | Liquid | 80% | 33% |
| `meta-llama/llama-3.3-70b-instruct` | `nebius/fp8` | Nebius | 27% | 27% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 62% | 69% |
| `nvidia/nemotron-3-nano-30b-a3b` | `novita/fp4` | Novita | 0% | n/a |
| `nvidia/nemotron-3-super-120b-a12b` | `digitalocean` | DigitalOcean | 68% | n/a |
| `nvidia/nemotron-nano-12b-v2-vl:free` | `nvidia` | Nvidia | 71% | 75% |
| `openai/gpt-oss-20b` | `google-vertex/us-central1` | Google | 75% | 80% |
