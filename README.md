...
## Current status (2026-09-05T13:15:57+00:00 UTC)

431 models polled, 1297 inference endpoints:
up 750, degraded 92, down 33, idle 422.

Currently down (33):

| model | endpoint | provider | 30m uptime | 5m uptime |
|---|---|---|---|---|
| `amazon/nova-micro-v1` | `amazon-bedrock/eu-west-1` | Amazon Bedrock | 23% | 5% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | n/a | n/a |
| `deepseek/deepseek-v4-flash-0731` | `makora` | Makora | 19% | 1% |
...
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 77% | 41% |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 61% | 70% |
| `google/gemma-3-27b-it` | `novita/bf16` | Novita | 76% | 63% |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 38% | 36% |
| `moonshotai/kimi-k2.7-code` | `venice/int4` | Venice | 45% | n/a |
| `moonshotai/kimi-k3` | `makora` | Makora | 11% | n/a |
| `nousresearch/hermes-4-70b` | `nebius/fp8` | Nebius | n/a | n/a |
| `openai/gpt-oss-120b` | `deepinfra/fp8` | DeepInfra | 78% | n/a |
