...
## Current status (2026-09-17T05:45:22+00:00 UTC)

444 models polled, 1338 inference endpoints:
up 793, degraded 100, down 24, idle 421.
...
| `deepseek/deepseek-chat-v3.1` | `mara` | Mara | 73% | 43% |
| `deepseek/deepseek-chat-v3.1` | `google-vertex/us-west2` | Google | 0% | n/a |
| `deepseek/deepseek-v4.1-flash` | `reka/fp4` | Reka | 74% | 46% |
...
| `google/gemini-3.7-flash` | `google-vertex/global/flex` | Google | 72% | 56% |
| `google/gemini-3.8-flash` | `google-vertex/global/flex` | Google | 79% | n/a |
| `google/gemma-3-27b-it` | `nebius/fp8` | Nebius | 77% | 59% |
| `google/gemma-4-31b-it` | `deepinfra/ultra` | DeepInfra | 53% | 100% |
| `minimax/minimax-m2.7` | `mara` | Mara | 63% | 70% |
| `minimax/minimax-m3` | `mara` | Mara | 57% | n/a |
| `mistralai/mistral-nemo` | `novita/fp8` | Novita | 18% | 100% |
| plus 9 more | | | | |
